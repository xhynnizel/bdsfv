...
export const photoboothIntro = {
  ...
  paragraphs: [
    ...
    <>
      For those who don't know what this link is all about, I put this little site together as a surprise for{" "}
      <strong>Viktor's birthday which is on September 7th</strong>, and I wanted you to be part of it too.
    </>,
    "- As you click the \"Continue\" button below, you'll be taken to the message form.",
    "- And then, you will write your message or a birthday wish for Viktor — as short or as long as you'd like.",
    "- If you want, you can also attach a photo. Just tap \"Attach a photo,\" upload or take 3 quick shots in the booth, decorate the strip with frames and stickers, and download it for yourself to keep.",
    "- After reviewing your message and attached photo, hit send.",
    "Everything you send goes straight to his private birthday wall, which only he can open — so don't hold back, he won't see any of this until the night of his birthday.",
  ],
