...
export const timeline = [
  {
    date: "Winter — Year One",
    caption:
      "The winter we met online — texting across time zones about nothing and everything, and somehow it was already the best part of my day.",
...
export const photoboothIntro = {
  ...
  paragraphs: [
    ...
    "Before you head to the message form, take a moment to think about your kindest memories with Viktor and what you'd like to say to him.",
    "And then, write him your message or a birthday wish — as short or as long as you'd like. If you want, you can also attach a photo. Just tap \"Attach a photo,\" upload or take 3 quick shots in the booth, decorate the strip with frames and stickers, and download it for yourself to keep. It'll automatically attach to your message when you hit send.",
  ...
  signoff: "Thank you for loving him with me",
};
