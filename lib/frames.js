...
export const frames = [
  ...
  //   name: "Music Theme",
  //   count: 1,
  //   bgImage: "/frames/single/5.png",
  //   aspect: 6 / 4,
  //   overlay: false,
  //   cells: [{ x: 0.04, y: 0.05, w: 0.92, h: 0.68 }],
  // },
  // {
  //   id: "single-7",
  //   name: "Cat Theme",
  //   count: 1,
  //   bgImage: "/frames/single/7.png",
  //   aspect: 6 / 4,
  //   overlay: false,
  //   cells: [{ x: 0.04, y: 0.04, w: 0.92, h: 0.72 }],
  // },
  // {
  //   id: "single-8",
  //   name: "Party Theme",
  //   count: 1,
  //   bgImage: "/frames/single/8.png",
  //   aspect: 6 / 4,
  //   overlay: false,
  //   cells: [{ x: 0.04, y: 0.06, w: 0.92, h: 0.70 }],
  // },
];
